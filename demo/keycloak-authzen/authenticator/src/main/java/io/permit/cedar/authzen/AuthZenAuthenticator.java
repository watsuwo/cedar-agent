...
/**
 * Browser-flow authenticator that asks an AuthZEN PDP (cedar-agent) whether the
 * authenticated user is allowed to log into the requesting client.
 *
...
public class AuthZenAuthenticator implements Authenticator {
    ...
    private static final String DEFAULT_PDP_URL = "http://cedar-agent:8180";
